from agents.scenario_agent import load_scenario_data, analyze_scenarios
from utils.helpers import load_data, forecast_with_arima, plot_forecast
...
if __name__ == "__main__":
    ...
    scenario_report = analyze_scenarios(scenarios)
